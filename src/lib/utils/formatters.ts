...
export function getScoreColor(score: number): string {
  if (score < 50) return 'text-monet-rose';
  if (score < 70) return 'text-monet-gold';
  return 'text-monet-sage';
}

export function getScoreBgColor(score: number): string {
  if (score < 50) return 'bg-monet-rose';
  if (score < 70) return 'bg-monet-gold';
  return 'bg-monet-sage';
}
...
export function getTrendColor(trend: 'improving' | 'stable' | 'declining'): string {
  switch (trend) {
    case 'improving': return 'text-monet-sage';
    case 'stable': return 'text-monet-mist';
    case 'declining': return 'text-monet-rose';
  }
}
