      ...
      <header className="border-b-3 border-foreground">
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            <h1 className="text-3xl font-black tracking-tight">Ralph</h1>
            {isPreviewMode && (
              <span className="inline-flex items-center gap-1 rounded-md border-2 border-foreground bg-amber-300 px-2 py-0.5 text-[10px] font-bold uppercase tracking-wide text-foreground shadow-[2px_2px_0px_0px_rgba(26,26,26,1)]">
