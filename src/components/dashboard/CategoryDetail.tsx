  ...
  return (
    <div className="space-y-4">
      {weekComparison && weekComparison.length > 0 && (
        <>
          <h3 className="text-lg font-black uppercase tracking-wide">This Week vs Last Week</h3>
      ...
      <h3 className="text-lg font-black uppercase tracking-wide">{title} Metrics</h3>
